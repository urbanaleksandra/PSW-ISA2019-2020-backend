...
INSERT INTO public.appointments (id, version, date, description, duration, patient,finished, type, doctor_id, hospital_room_id, medical_record_id, doctor_username,type2_id) VALUES (nextval('appointments_id_seq'),0,'2020-02-05T16:00', 'cold', 2, 'masa', false,'appointment', 2, null, 1, 'doctor',1);
